...
void MainWindow::display_sorted_by_team_names_american()
{
    ...
    int sz = graph->get_vcount();
        ...
        for (int q = 0; q < sz; q++){
            if (temp[q].get_american_league() == true){
                ...
                std::cout << american_league[american_league_sz].get_stadium_name() << "    " << american_league[american_league_sz].get_date_opened() << std::endl;
                american_league_sz++;
            }
        }
    ...
    for (int i = 0; i < american_league_sz; i++){
        ...
        if (i_min != i){
            ///**cant use swap on objects?
            ///**why doesnt hard code work either?

//            string input_stadium_name = american_league[i].get_stadium_name();
//            string input_team_name = american_league[i].get_team_name();
//            string input_street_address = american_league[i].get_street_address();
//            string input_city_state_zip = american_league[i].get_city_state_zip();
//            string input_box_office_number = american_league[i].get_box_office_number();
//            string input_date_opened = american_league[i].get_date_opened();
//            int input_seating_capacity = american_league[i].get_seating_capacity();
//            bool input_american_league = american_league[i].get_american_league();
//            bool input_grass = american_league[i].get_grass();

//            american_league[i].set_stadium_name(american_league[i_min].get_stadium_name());
//            american_league[i].set_team_name(american_league[i_min].get_team_name());
//            american_league[i].set_street_address(american_league[i_min].get_street_address());
//            american_league[i].set_city_state_zip(american_league[i_min].get_city_state_zip());
//            american_league[i].set_box_office_number(american_league[i_min].get_box_office_number());
//            american_league[i].set_date_opened(american_league[i_min].get_date_opened());
//            american_league[i].set_seating_capacity(american_league[i_min].get_seating_capacity());
//            american_league[i].set_american_league(american_league[i_min].get_american_league());
//            american_league[i].set_grass(american_league[i_min].get_grass());

//            american_league[i_min].set_stadium_name(input_stadium_name);
//            american_league[i_min].set_team_name(input_team_name);
//            american_league[i_min].set_street_address(input_street_address);
//            american_league[i_min].set_city_state_zip(input_city_state_zip);
//            american_league[i_min].set_box_office_number(input_box_office_number);
//            american_league[i_min].set_date_opened(input_date_opened);
//            american_league[i_min].set_seating_capacity(input_seating_capacity);
//            american_league[i_min].set_american_league(input_american_league);
//            american_league[i_min].set_grass(input_grass);



//            american_league[i].set_stadium_name(american_league[i_min].get_stadium_name());
//            american_league[i_min].set_stadium_name("test");
...
//    american_league[0].set_stadium_name("bbbbbbbbbbbb");
//    american_league[7].set_stadium_name("zzzzzzzzzz");
//    american_league[14].set_stadium_name("cccccccccccccc");

    for (int k = 0; k < american_league_sz; k++){
        output_Str += american_league[k].display_stadium_info();
//        american_league[k].set_stadium_name("test");
//        std::cout << american_league[k].get_stadium_name() << "    " << american_league[k].get_date_opened() << std::endl;
        output_Str += "\n";
    }
    ui->displayBox->setText(QString::fromStdString(output_Str));
